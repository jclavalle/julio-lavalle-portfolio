        ...
        <div className="top">
          <div className="left">
            <div className="figure" id="fig">
              ...
              >
                ...
                <line x1="74" y1="184" x2="162" y2="184" stroke="var(--ink-2)" strokeWidth=".8" strokeDasharray="2 3" />
                <polyline points="74,206 86,168 98,198 110,176 122,190 134,181 146,185 162,184" fill="none" stroke="var(--ink)" strokeWidth="1.3" strokeLinejoin="round" />
                ...
                <g id="labels" />
                <g id="dots" />
                <circle id="selring" r="12" fill="none" stroke="var(--ink)" strokeWidth="1.2" />
              </svg>
            </div>
          ...
          <div className="intro">
            ...
            <aside className="card card-sig" id="sig" aria-live="polite">
              ...
              <p className="sig-name" id="s-name" />
              <div className="sig-meta">
                <div><span className="k">Layer</span><span className="v" id="s-ring" /></div>
                <div>
                  <span className="k">Durability</span>
                  <span className="v"><i className="dotk" id="s-dot" /><span id="s-dur" /></span>
                </div>
                <div><span className="k">When</span><span className="v" id="s-when" /></div>
              </div>
            ...
            <aside className="card card-nber">
              ...
              <div className="nb-stats">
                <div><b>+240%</b><span>Commits</span></div>
                <div><b>+80%</b><span>Projects</span></div>
                <div><b>+30%</b><span>Releases</span></div>
              </div>
          ...
          <svg className="conn" aria-hidden="true">
            <path id="conn" d="" />
          </svg>
        </div>
      </div>
